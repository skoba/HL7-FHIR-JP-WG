...
VALID_XML = File.join(SAMPLE_LOCATION, 'valid_xml.xml')
INVALID_XML = File.join(SAMPLE_LOCATION, 'invalid_xml.xml')
VALID_JSON = File.join(SAMPLE_LOCATION, 'valid_json.json')
INVALID_JSON = File.join(SAMPLE_LOCATION, 'invalid_json.json')
